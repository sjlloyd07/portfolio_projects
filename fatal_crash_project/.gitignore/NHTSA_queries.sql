...
----** CREATE TABLE accident_clean FOR DATA TO KEEP **----

-- CREATE TABLE accident_clean (
-- 	id INT PRIMARY KEY,
-- 	state VARCHAR(255),
-- 	county VARCHAR(255),
-- 	roadway_type VARCHAR(255),
-- 	roadway_name VARCHAR(255),
-- 	rural_urban VARCHAR(255),
-- 	harmful_event VARCHAR(255),
-- 	collision_type VARCHAR(255),
-- 	light_conditon VARCHAR(255),
-- 	weather VARCHAR(255),
-- 	date DATE,
...
----** INSERT accident_raw_2019 COLUMNS INTO accident_clean **----
---- rename columns for legibility

-- INSERT INTO accident_clean(id, state, county, roadway_type, roadway_name, rural_urban, harmful_event,
-- 					collision_type, light_condition, weather, date, day_of_week, hour, fatals)
-- SELECT
-- 	st_case,  		--> id (primary key)
-- 	state_name,		--> state
-- 	county_name,	--> county
-- 	route_name,		--> roadway_type
-- 	tway_id,		--> roadway_name
